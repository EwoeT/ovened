...
// brand
  function brand(){
    ...
    <div class="header col-12" >
      ...
      <p><a href="index.php" class="name" style="margin-left: 20px; color: #f79e02; text-decoration: none;">oVened </a></p>
    </div>
    <?php
  }
    ...
    <nav class="navbar-default navbar-expand-md navbar-dark navb col-12" role="navigation" style="background-color: #f79e02;">
     ...
     <div class="container-fluid">
       ...
       <div class="collapse navbar-collapse col-12" id="navbarSupportedContent" >
        <ul id="menu" class="nav navbar-nav col-12" >
              ...
              <li class="navv dropdown"><a href="megrouploans.php" style="color:#3b3a35; text-decoration:none;" onmouseover="this.style='color:black; text-decoration:none;'" onmouseout="this.style='color:#3b3a35;  '">browse</a>
                  <ul class="dropdown-menu" style="background-color: rgba(247, 158, 2, 0.8); text-decoration: none; " >
                  <li><a href="megrouploans.php">trending</a></li>
                  <li><a href="smeloans.php">latest</a></li>
                  <li><a href="micro_insurance.php">popular</a></li>
                  <li><a href="educationloans.php">recent buys</a></li>
                  
                  </ul>
                  </li>
           <li class="navv"><a href="bakeries.php" style="color:#3b3a35; text-decoration:none;" onmouseover="this.style='color:black; text-decoration:none;'" onmouseout="this.style='color:#3b3a35;  '">bakeries</a></li> 
          <li class="navv"><a href="about.php" style="color:#3b3a35; text-decoration:none;" onmouseover="this.style='color:black; text-decoration:none;'" onmouseout="this.style='color:#3b3a35;  '">about us</a></li>
          <li class="navv"><a href="selling.php" style="color:#3b3a35; text-decoration:none;" onmouseover="this.style='color:black; text-decoration:none;'" onmouseout="this.style='color:#3b3a35;  '">selling</a></li>
...
<footer class="page-footer font-small unique-color-dark pt-0">
        ...
        <div class="row mt-3">
            ...
            <div class="offset-1 col-md-3 col-lg-4 col-xl-3 mb-4">
                <h6 class="text-uppercase font-weight-bold">
                    <strong style="color: #f79e02">ovened.com</strong>
                </h6>
            ...
            <div class="col-md-4 col-lg-3 col-xl-3">
                ...
                <p>
                    <i class="fa fa-envelope mr-3"></i> info@ovened.com</p>
                <p>
    ...
    <div class="copyright text-md-right" style="padding-top: 10px; padding-bottom: 20px; padding-right: 20px; background-color: #4c4947; color: #e1e6f9" >
        ...
        <a href="https://mdbootstrap.com/material-design-for-bootstrap/">
            <span style="color: #e1e6f9; font-size: small; text-decoration: none;"> ovened.com</span>
        </a>
    </div>
    <!--/.Copyright -->
...
// connection
$con = mysqli_connect("localhost", "ewoe", "ewoe", "ovened");
...
function products(){
  global $con;
  $query = "select *, bakery_name from product join bakery on bakery.bakery_id = product.bakery_id order by RAND() LIMIT 0,8";
  $run_query = mysqli_query($con, $query);
  ...
  while ($row = mysqli_fetch_array($run_query)) {
    ...
    $image = $row['image'];
    $price = $row['price'];
    $bakery = $row['bakery_name'];
    ?>
     <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 text-center" style="margin-bottom: 20px;"><?php echo"<a href='product.php?product_id=$product_id'><img class='img-fluid' src='$image' height='' width='' style='max-height: 220px; min-height: 220px; max-width: 240px; min-width: 240px;'> </a>" ?>
        <div class="row">
          <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
            ...
            <p style="font-size: small;"> <span>baker:</span> <span style="margin-bottom: 0px; color: #f79e02;"><?php echo"$bakery" ?><span></p>
...
// display top rated bakeries
function top_bakeries(){
  global $con;
  $query = "select * from bakery LIMIT 0,8";
  $run_query = mysqli_query($con, $query);
  ...
  while ($row = mysqli_fetch_array($run_query)) {
    ...
    $bakery = $row['bakery_name'];
    ?>
     <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 text-center" style="margin-bottom: 20px;">
        <div class="row">
          <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
            <p style="font-size: small;"> <span>baker:</span> <span style="margin-bottom: 0px; color: #f79e02;"><?php echo"$bakery" ?><span></p>
              <p style="font-size: small;"> <span>rating:</span> <span style="margin-bottom: 0px; color: #f79e02;">ooooo<span></p>
          </div>
        </div>
...
// display recently bought bakeries
function recent_bakeries(){
  global $con;
  $query = "select * from bakery LIMIT 0,4";
  $run_query = mysqli_query($con, $query);
...
// display new bakeries
function new_bakeries(){
  global $con;
  $query = "select * from bakery LIMIT 0,4";
  $run_query = mysqli_query($con, $query);
